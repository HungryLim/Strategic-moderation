setwd("C:/Users/wooki/Desktop/bonica")
setwd("C:/Users/Dell/Desktop/Bonica")


#want<-read.csv("bod_fortune_500_DIME_cont_records.csv",header=TRUE)
name<-read.csv("corp_name_loop3.csv",header=TRUE)
...
repeat {
  ...
  #datalist[[index]]<- dataChunk$candidate.cfscore[match(want$dime.rid, dataChunk$bonica.rid)]
...
nrow(big_data)
write.csv(big_data, file = "big_dataff33.csv")
